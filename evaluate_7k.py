...
def calculate_metrics(args):
    loss_fn_alex = lpips.LPIPS(net='squeeze').cuda()
    gt_folder = args['gt'] + '/*'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--input',type=str,default='./data/result(100_epoch)/input')
    parser.add_argument('--gt',type=str,default='./data/result(100_epoch)/pred_blend')
    parser.add_argument('--mask',type=str,default='./data/result(100_epoch)/pred_flare')
