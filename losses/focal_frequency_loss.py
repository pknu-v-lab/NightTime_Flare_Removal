...
class FocalFrequencyLoss(nn.Module):
    def __init__(
        ...
        :param alpha: the scaling factor alpha of the spectrum weight matrix
            for flexibility. Default: 1.0
        :param patch_factor: the factor to crop image patches for patch-based
            focal frequency loss. Default: 1
        :param ave_spectrum: whether to use minibatch average spectrum. Default: False
        :param log_matrix: whether to adjust the spectrum weight matrix by logarithm.
            Default: False
        :param batch_matrix: whether to calculate the spectrum weight matrix
    ...
    def __repr__(self):
        attrs = ["alpha", "patch_factor", "ave_spectrum", "log_matrix", "batch_matrix"]
    ...
    def loss_formulation(self, recon_freq, real_freq, matrix=None):
        ...
        if matrix is not None:
            ...
            # if the matrix is calculated online:
            # continuous, dynamic, based on current Euclidean distance
            ...
            # whether to calculate the spectrum weight
            # matrix using batch-based statistics
